...
- [M] app/database.py
- [M] app/main.py
- [M] app/routers/admin_integrations.py
- [M] app/routers/admin.py
- [M] app/routers/advisor.py
- [M] app/routers/jarvis_router.py
- [M] app/routers/leads.py
- [M] app/routers/metrics.py
- [M] app/routers/tts.py
- [??] app/services/jarvis_access.py
- [??] app/services/jarvis_observability.py
- [M] app/services/jarvis.py
- [M] app/services/llm_client.py
- [M] app/services/runtime_config.py
- [M] app/services/tts_service.py
- [M] app/tasks/email_tasks.py
...
- [M] src/App.jsx
- [M] src/components/SEO.jsx
- [??] src/config/
- [M] src/lib/ElevenLabsService.js
- [??] src/lib/siteProfiles.js
- [M] src/main.jsx
- [M] src/pages/CommandCenter.jsx
- [??] src/pages/MarketLanding.jsx

## legal-datasets (10)

- [M] src/data/legal/buildingPermits.js
- [M] src/data/legal/constructionLicensing.js
- [M] src/data/legal/environmentalPermits.js
- [M] src/data/legal/mechanicsLienLaws.js
- [M] src/data/legal/prevailingWage.js
- [M] src/data/legal/promptPaymentLaws.js
- [M] src/data/legal/roadsAndPavingRegulations.js
- [M] src/data/legal/states.js
...
- [M] tests/e2e/public-pages-smoke.spec.js
