...
Routes:
  GET /api/v1/materials/price-index — current asphalt price index (public)

No authentication required (public EIA data).
"""
...
async def asphalt_price_index(request: Request):
    """
